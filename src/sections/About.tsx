      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              <a
                href="#contact"
                className="inline-block px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
              >
                Let's Work Together
              </a>
            </div>
          ...
          <div className="space-y-6">
            {highlights.map((item, index) => (
              <div
                key={index}
                className="flex gap-4 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg hover:shadow-lg transition-shadow duration-300"
              >
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            <FaBriefcase className="text-blue-600 dark:text-blue-400" size={32} />
              ...
              return (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4">
                    ...
                    <span className="text-gray-600 dark:text-gray-400 font-medium mt-2 sm:mt-0">
                      {exp.period}
                    </span>
                  </div>
                  <ul className="space-y-2">
                    {exp.description.map((item, idx) => (
                      <li key={idx} className="flex gap-3 text-gray-700 dark:text-gray-300">
                        <FaCheckCircle className="text-green-500 flex-shrink-0 mt-1" size={16} />
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
